...
public partial class TickerDb : DbContext
{
    public TickerDb()
    {
    }

    public TickerDb(DbContextOptions<TickerDb> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=TickerDb;User ID=sa;Password=Kyalayum;Encrypt=False");
